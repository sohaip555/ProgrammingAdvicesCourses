...
bool IsOverlapPeriods(stPeriods Priods1, stPeriods Priods2)
{
    if (
    CombarDateFunction(Priods2.EndDate, Priods1.StartDate) == enDateCombar::Before 
    || 
    CombarDateFunction(Priods2.StartDate, Priods1.EndDate) == enDateCombar::After )
    {
        return false;
    }
    else
...
int main()
{
    ...
    {
        cout << "\nYes, Priods Overlap" << endl;
    }
    else
    {
        cout << "\nNo, is not Priods Overlap" << endl;
    }
